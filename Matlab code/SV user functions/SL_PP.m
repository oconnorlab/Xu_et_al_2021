function SL_PP(obj)
%SL_PP Summary of this function goes here
...
elseif obj.BeginWith('water,')
    ...
    C = 25; % spare first C-1 trials. must be an odd number
    T = 24; % cycle period. must be 4 times an even number
    probeInd0 = {[], C:T:1000, C+T/4:T:1000};
    probeInd1 = {[], C+1+T/4*2:T:1000, C+1+T/4*3:T:1000};
    
    [seqCmd, trCmd] = get_sequence_cmd(trialNum+1, seqProb0, seqProb1, probeInd0, probeInd1);
    obj.SendMessage(seqCmd, trCmd);
