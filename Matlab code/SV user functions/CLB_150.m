...
elseif obj.BeginWith('sessionStart,')
    ...
    obj.userData.trials = 1;
    obj.SendMessage('Blk,1');
...
elseif obj.BeginWith('trialNum,')
    ...
    t0 = ss{2} / 1000;
    trialNum = ss{3};
    title(ax1, ['\color{blue}Trial ' num2str(trialNum)]);
...
elseif obj.BeginWith('water,')
    ...
    % Update sequence
    seqProb0 = [0.5 0.5 0 0];
    seqProb1 = seqProb0;
    blockLength = 10;
    [seqCmd, ~] = get_sequence_block_cmd(obj.userData.trials, blockLength, seqProb0, seqProb1);
