...
hist_data_dir = 'C:\Users\yaxig\Dropbox (oconnorlab)\Documents\RnD\OConnor Lab\Project Seqlick\SHARP-Track data';
processed_images_folder = fullfile(hist_data_dir, [mouse_id ' processed']);

% directory of reference atlas files
allenCCF_data_dir = 'C:\Users\yaxig\Dropbox (oconnorlab)\Documents\RnD\OConnor Lab\Repos\allenCCF data';
annotation_volume_location = fullfile(allenCCF_data_dir, 'annotation_volume_10um_by_index.npy');
structure_tree_location = fullfile(allenCCF_data_dir, 'structure_tree_safe_2017.csv');

% name of the saved probe points
probe_save_name_suffix = ['_' mouse_id '_tract_1'];
